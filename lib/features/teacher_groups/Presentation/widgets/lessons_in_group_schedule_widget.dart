      ...
      builder: (BuildContext context) => CupertinoActionSheet(
        ...
        actions: [
          CupertinoActionSheetAction(
            onPressed: () {
              const TeacherEditClass(date: '', lessonStartTime: '', lessonFinishTime: '', group: '', subject: '',);
            },
            child: Text(
              'Изменить',
              style: TextStyle(
        ...
        BottomSheetAction(
          ...
          onPressed: (_) {
            ...
            showModalBottomSheet(
              ...
              context: context,
              builder: (context) => const TeacherEditClass(date: '', lessonFinishTime: '', lessonStartTime: '', group: '', subject: '',),
            );
          },
        ),
      ],
