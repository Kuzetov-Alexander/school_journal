...
class StickyHeadersTable extends StatefulWidget {
  StickyHeadersTable({
    ...
    /// Обратные вызовы при нажатии на ячейку
  ...
  @override
  StickyHeadersTableState createState() => StickyHeadersTableState();
}

class StickyHeadersTableState extends State<StickyHeadersTable> {
          ...
          children: <Widget>[
            ...
            Expanded(
              child: NotificationListener<ScrollNotification>(
                child: Scrollbar(
                  // Key is required to avoid 'The Scrollbar's
